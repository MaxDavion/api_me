# PetShop OpenAPI Specification
[![Build Status](https://travis-ci.org/MaxDavion/api_me.svg?branch=master)](https://travis-ci.org/MaxDavion/api_me)
...
6. If you did everything correct, https://maxdavion.github.io/api_me/ will lead to your new docs
...
- Documentation(ReDoc): https://maxdavion.github.io/api_me/
- SwaggerUI: https://maxdavion.github.io/api_me/swagger-ui/
- Look full spec:
    + JSON https://maxdavion.github.io/api_me/swagger.json
    + YAML https://maxdavion.github.io/api_me/swagger.yaml
- Preview spec version for branch `[branch]`: https://maxdavion.github.io/api_me/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://maxdavion.github.io/api_me/ with url from the message: `Server started <url>`
